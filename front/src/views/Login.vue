    ...
    <div class="container">
      <div class="login">
        ...
        <div class="login_box">
          ...
          <!-- 可以简写为required -->
          <input type="text" v-model="username" required autocomplete="off"/><label>用户名</label>
        </div>
        <div class="login_box">
          <input type="password" v-model="password" required="required" autocomplete="off"/><label>密码</label>
        </div>
